    ...
    <fieldset>
        ...
        <p>
         ...
         <p>
            ...
            <input type="text" value="<?php echo $o->get('codepostal'); ?>" name="codepostal" id="addpost" required/>
        </p>
        <p>
        ...
        <form method="post" action="?action=update&controller=administrateur&type=Planetes&id=<?php echo $id ?>">
            ...
            <fieldset>
                ...
                <p>
                    ...
                    <input type="text"  name="id" id="id" value='<?php echo htmlspecialchars($o->get('id')); ?>' readonly/>
                </p>
                <p>
                    <label for="prix">Prix</label> :
                    <input type="text"  name="prix" id="prix" value='<?php echo htmlspecialchars($o->get('prix')); ?>' required/>
                </p>
                <p>
                    <label for="qte">Quantité en Stock</label> :
                    <input type="number"  name="qteStock" id="qte" value='<?php echo htmlspecialchars($o->get('qteStock')); ?>' required/>
                </p>
                <p>
                    <label for="img">Lien Image</label> :
                    <input type="text"  name="img" id="img" value='<?php echo htmlspecialchars($o->get('image')); ?>' required/>
                </p>
                <p>
                    <input type="submit" value="Envoyer" />
                </p>
